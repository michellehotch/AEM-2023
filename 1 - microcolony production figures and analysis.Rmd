...
mcdata$treatment <- case_match(mcdata$treatment, "Control" ~ "Control", "DMSO" ~ "DMSO", "1ppb" ~ "1 ng/µL", "10ppb" ~ "10 ng/µL", "100ppb" ~ "100 ng/µL", "800ppb" ~ "800 ng/µL")

mcdata$treatment <- factor(mcdata$treatment, levels = c("Control", "DMSO", "1 ng/µL", "10 ng/µL", "100 ng/µL", "800 ng/µL"))
